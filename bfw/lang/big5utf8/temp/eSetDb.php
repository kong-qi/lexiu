...
<form name="form1" method="post" action="phome.php">
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#0472BC" id="setuser" style="display=none">
    ...
    <tr> 
      ...
      <td height="25" bgcolor="#FFFFFF"> <input name="adminusername" type="text" id="adminusername" value="<?=$set_username?>"></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td height="25" bgcolor="#FFFFFF"><input name="outtime" type="text" id="outtime" value="<?=$set_outtime?>" size="6">
        分鐘</td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF">登陸是否需要驗證碼</td>
