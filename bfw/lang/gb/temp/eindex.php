...
<table width="100%" border="0" cellspacing="8" cellpadding="3">
  <tr>
    ...
    <tr>
      <td><div align="center"><strong><font size="5">欢迎使用&nbsp;EmpireBak&nbsp;v2008</font></strong></div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table width="420" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#0472BC">
        <form name="form1" method="post" action="phome.php">
          ...
          <tr> 
            <td height="25" colspan="2"><div align="center"><strong><font color="#FFFFFF">管理员登陆</font></strong></div></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
	...
	?>
          <tr bgcolor="#FFFFFF"> 
            <td height="25">&nbsp;</td>
            <td height="25"><input type="submit" name="Submit" value="登陆"> <input type="reset" name="Submit2" value="重置"></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
