...
//本页配置信息
$pagename="信息";
$actionmd5=md5("message_add");
$btnaction="";//提交状态
$message="没有添加信息权限";//游客提示语
//获取当前栏目信息
        ...
        <table class="tableBasic" border="0" cellpadding="8" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <?php
              ...
              {
                echo '<textarea  name="kq_title" id="kq_title" cols="80" class="textArea" rows="5"></textarea>';
              }else
              {
                echo ' <input name="kq_title" size="40" class="inpMain" type="text" id="kq_title">';
              }
            ?>
          ...
          switch($lanmumsg['kq_type'])
          {
            ...
            ?>
             <tr>
               ...
               <td colspan="2"><input name="kq_guanjc" size="20" class="inpMain" type="text" id="kq_source" /></td>
             </tr>
             <tr>
               <td align="right">地址：</td>
               <td colspan="2"><input name="kq_address" size="20" class="inpMain" type="text" id="kq_source" /></td>
             </tr>
             <tr>
               <td align="right">电话：</td>
               <td colspan="2"><input name="kq_tel" size="20" class="inpMain" type="text" id="kq_source" /></td>
             </tr>
             <tr>
               <td align="right">qq：</td>
               <td colspan="2"><input name="kq_qq" size="20" class="inpMain" type="text" id="kq_source" /></td>
             </tr>
             <tr>
               <td align="right">微信：</td>
               <td colspan="2"><input name="kq_weixin" size="20" class="inpMain" type="text" id="kq_source" /></td>
             </tr>
             <tr>
                 <td align="right">正文：</td>
                   <td colspan="2"><textarea  name="kq_content" id="kq_content" cols="80" rows="5"></textarea></td>
             </tr>
            <?php
            break;
            case "advlist":
            ?>
              <tr>
                ...
                <td colspan="2"><input name="kq_source" size="20" class="inpMain" type="text" id="kq_source" /></td>
              </tr>
              <tr>
                <td align="right">缩略图：</td>
                <td colspan="2"><input name="kq_picurl" size="40" class="inpMain" type="text" id="kq_pic" />
                  <input name="submit2" class="btn" onclick="updatepic('kq_pic','ylpics','','','710','410','1')" value="点击上传" type="button" />
                </td>
              </tr>
              <tr>
                <td align="right" >图片预览：</td>
                <td colspan="2" id="ylpics"><img src="images/nopic.gif" class="fmpic" height="100"  /></td>
              </tr>
              ...
              <tr>
                ...
                <td><input name="kq_sttime" size="40" class="inpMain" type="text" id="kq_sttime" /></td>
              </tr>
              <tr>
                 <td align="right">开始时间</td>
                 <td><input name="kq_endtime" size="40" class="inpMain" type="text" id="kq_endtime" /></td>
              </tr>
         ...
         <!--  <tr>
           ...
           <td colspan="2">
           <textarea name="kq_intro" id="kq_intro" class="textArea" cols="45" rows="5"></textarea></td>
         </tr> -->
        ...
        <table class="tableBasic" border="0" cellpadding="8" cellspacing="0" width="100%">
          <tbody>
           <tr>
              ...
              <td colspan="2"><textarea  name="kq_mbcontent" id="kq_mbcontent" cols="80" rows="5"></textarea></td>
            </tr>
          </tbody>
        </table>
      </div>
          ...
          <table class="tableBasic" border="0" cellpadding="8" cellspacing="0" width="100%">
            <tbody>
             <tr>
                ...
                <td><input name="kq_keyword" size="80" class="inpMain" type="text" id="kq_keyword" /></td>
              </tr>
              <tr>
                    <td align="right">SEO描述</td>
                    <td><textarea name="kq_description" cols="70" rows="5" class="textArea" id="kq_description"></textarea></td>
              </tr>
            </tbody>
          </table>
      </div>
 ...
 <script>
    $(document).on('click', '.open_city', function(event) {
        ...
        $(document).on('click', '.city_ul li', function(event) {
          ...
          if(status!=1)
          {
            $(".select_add .add_city").append('<li>'+title+'<input type="hidden" name="city[]" value="'+id+'"></li>');
